...
public ActionResult Requestbook(string BookTitle, string Author, string Publisher, string Reason, string Email)
{
    ...
    return View();
        ...
        {
            string qrImageUrl = "https://yourdomain.com/images/generated_qr.png"; 
     ...
     string fineAmount)
        {
            try
            {
                ...
                smtp.Credentials = new NetworkCredential("nikhilkale1617@gmail.com", "mgna zbmq ogrh iclj");
                smtp.EnableSsl = true;
            ...
            return RedirectToAction("CalculateFine"); 
        }
